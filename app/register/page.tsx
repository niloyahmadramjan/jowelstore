    ...
    <div className="min-h-screen flex items-center justify-center bg-stone-50 dark:bg-stone-950 px-4 py-12">
      ...
      >
        ...
        <div className="bg-white dark:bg-stone-900 rounded-2xl shadow-xl dark:shadow-stone-950/50 border border-stone-100 dark:border-stone-800 p-8">
          ...
          >
            {gLoading ? <Spinner color="muted" /> : <GoogleIcon />}
          ...
          <div className="flex items-center gap-3 my-6">
            ...
            <span className="text-xs text-stone-400 dark:text-stone-500">or register with email</span>
            <div className="flex-1 h-px bg-stone-200 dark:bg-stone-700" />
          </div>
          ...
          <AnimatePresence>
            {success && (
              <motion.div
                ...
                exit={{ opacity: 0 }}
                transition={{ duration: 0.2 }}
                className="flex items-center gap-2 mb-5 px-4 py-3 rounded-xl bg-green-50 dark:bg-green-950/40 border border-green-200 dark:border-green-800/50 text-green-700 dark:text-green-400 text-sm"
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <svg className="absolute left-3.5 top-1/2 -translate-y-1/2 text-stone-400 dark:text-stone-500 pointer-events-none" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.38 2 2 0 0 1 3.6 1.21h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.77a16 16 0 0 0 6.29 6.29l1.63-1.64a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/>
                </svg>
                <input
                  type="tel"
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.01 }}
              whileTap={{ scale: 0.98 }}
              className="w-full flex items-center justify-center gap-2.5 py-3 px-6 mt-2 rounded-xl text-sm font-semibold text-white bg-green-700 hover:bg-green-800 shadow-lg shadow-green-700/25 disabled:opacity-65 disabled:cursor-not-allowed transition-colors duration-200"
            >
              {loading ? (
                <><Spinner color="white" /> Creating account...</>
              ) : (
                "Create Account"
              )}
            </motion.button>
        ...
        <p className="text-center text-sm text-stone-500 dark:text-stone-400 mt-6">
          ...
          <a href="/login" className="font-semibold text-green-700 dark:text-green-500 hover:text-green-800 transition-colors">
            Sign in
          </a>
        </p>
      </motion.div>
