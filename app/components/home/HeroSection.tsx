...
const SLIDES = [
  {
    ...
    headline:      "Farm Fresh",
    highlight:     "Groceries",
    sub:           "Handpicked vegetables, fruits & dairy — straight from the farm, delivered daily.",
    cta:           "Shop Groceries",
    ctaHref:       "/groceries",
    secondary:     "View Offers",
    secondaryHref: "/offers",
    stat1:         { value: "500+",  label: "Products"  },
    stat2:         { value: "Daily", label: "Restocked" },
  ...
  },
  {
    ...
    headline:      "Finest",
    highlight:     "Jewellery",
    sub:           "Handcrafted gold, silver & diamond pieces. Every design certified, every piece timeless.",
    cta:           "Shop Jewellery",
    ctaHref:       "/jewellery",
    secondary:     "View Collection",
    secondaryHref: "/jewellery",
    stat1:         { value: "200+",  label: "Designs"   },
    stat2:         { value: "100%",  label: "Certified" },
    stat3:         { value: "4.8★",  label: "Rating"    },
    accent:        "#b45309",
    accentBright:  "#fbbf24",
    bg:            "from-[#1c1207] via-[#451a03] to-[#78350f]",
    emoji:         ["💍", "👑", "💎", "✨", "🪙", "🔮"],
  },
  {
    id:            3,
    ...
    headline:      "Exclusive",
    highlight:     "Deals",
    sub:           "Up to 40% off on selected groceries & jewellery. Free delivery on orders above ৳999.",
    cta:           "Grab Deals",
    ctaHref:       "/offers",
    secondary:     "All Products",
    secondaryHref: "/search",
    stat1:         { value: "40%",   label: "Off"      },
    stat2:         { value: "Free",  label: "Delivery" },
    stat3:         { value: "Today", label: "Only"     },
    accent:        "#7c3aed",
    accentBright:  "#a78bfa",
