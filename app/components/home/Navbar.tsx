...
export default function Navbar() {
  ...
  /* ── Focus / clear on search open/close ────────── */
  useEffect(() => {
    if (searchOpen) {
          ...
          <div className="flex items-center justify-between h-16 gap-3">
            ...
            <Link href="/" className="flex items-center gap-2.5 shrink-0">
              ...
              <div className="leading-none">
                <p className="text-stone-900 dark:text-white font-bold text-base leading-none">
                  জুয়েল স্টোর
                </p>
                <p className="text-green-600 text-[10px]">Jowel Store</p>
              </div>
            </Link>
            ...
            <div className="flex items-center gap-1 sm:gap-1.5">
              ...
              >
                <Search size={17} />
                <span className="hidden md:block text-sm text-stone-400 dark:text-stone-500 w-20 text-left">
                  খুঁজুন...
                </span>
              </button>
