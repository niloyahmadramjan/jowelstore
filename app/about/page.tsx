...
export const metadata: Metadata = {
  title: "আমাদের সম্পর্কে — জুয়েল স্টোর",
  description:
    "জুয়েল স্টোর — আপনার পাড়ার বিশ্বস্ত মুদি দোকান। সেরা মানের পণ্য, সেরা দামে।",
};
...
const VALUES = [
  {
    Icon: ShieldCheck,
    title: "বিশ্বস্ততা",
    desc: "প্রতিটি পণ্যের মান নিশ্চিত করে তবেই বিক্রি করা হয়।",
  },
  {
    Icon: Truck,
    title: "দ্রুত সেবা",
    desc: "ঢাকার ভেতরে একই দিনে ডেলিভারি দেওয়া আমাদের লক্ষ্য।",
  },
  {
    Icon: BadgePercent,
    title: "সেরা দাম",
    desc: "বাজারের চেয়ে সবসময় কম দামে সেরা পণ্য পাবেন।",
  },
  {
    Icon: Heart,
    title: "ক্রেতার সন্তুষ্টি",
    desc: "আপনার সন্তুষ্টি না হলে পণ্য ফেরত বা পরিবর্তন করা হবে।",
  },
];
      ...
      <div className="bg-gradient-to-br from-[#052e16] via-[#14532d] to-[#166534] py-16 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-white/75 text-base sm:text-lg leading-relaxed">
            আপনার পাড়ার বিশ্বস্ত মুদি দোকান — যেখানে পাবেন চাল, ডাল, তেল, মশলা
            থেকে শুরু করে সাবান, শ্যাম্পু সহ প্রতিদিনের সব প্রয়োজনীয় পণ্য।
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-14">
        ...
        <section className="bg-white dark:bg-stone-900 rounded-2xl border border-stone-100 dark:border-stone-800 p-6 sm:p-8 shadow-sm">
          ...
          <div className="space-y-4 text-stone-600 dark:text-stone-400 text-sm leading-relaxed">
            <p>
              জুয়েল স্টোর শুরু হয়েছিল একটি ছোট মুদি দোকান হিসেবে। আমাদের
              লক্ষ্য ছিল পাড়ার মানুষদের কাছে সেরা মানের পণ্য সাশ্রয়ী দামে
              পৌঁছে দেওয়া।
            </p>
            <p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {[
              ...
              },
              {
                Icon: Mail,
                label: "ইমেইল",
                value: "info@jowelstore.com",
                href: "mailto:info@jowelstore.com",
              },
              {
                Icon: Clock,
                label: "সময়সূচি",
                value: "সকাল ৮টা — রাত ১০টা (৭ দিন)",
                href: null,
              },
